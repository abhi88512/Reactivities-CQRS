...
const useActivities = (id?: string) => {
    ...
    const { data: activities, isLoading, isFetchingNextPage, fetchNextPage, hasNextPage } 
    ...
    const createActivity = useMutation({
        mutationFn: async (activity: Activity) => {
            const reponse = await agent.post('/activities', activity);
            return reponse.data;
        },
        onSuccess: async () => {
            await queryClient.invalidateQueries({
    ...
    const updateAttendance = useMutation({
        ...
        onMutate: async (id: string) => {
            ...
            const prevActivity = queryClient.getQueryData<Activity>(['activities', id]);
        ...
        onError: (error, id, context) => {
            ...
            if (context?.prevActivity) {
                queryClient.setQueryData<Activity>(['activities', id], context.prevActivity);
